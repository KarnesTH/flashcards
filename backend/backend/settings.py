...
DJOSER = {
    ...
    'SERIALIZERS': {
        'user_create': 'cards.serializers.CustomUserCreateSerializer',
        'user': 'cards.serializers.CustomUserSerializer',
        'current_user': 'cards.serializers.CustomUserSerializer',
    },
    'PERMISSIONS': {
